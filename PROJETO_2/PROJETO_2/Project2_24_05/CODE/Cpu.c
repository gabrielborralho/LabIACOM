...
void PE_low_level_init(void)
{
  ...
  clrReg8Bits(OC7M, 0x07U);             
  /* TIOS: IOS2=1,IOS1=1,IOS0=1 */
  setReg8Bits(TIOS, 0x07U);             
  /* TCTL2: OM2=0,OL2=0,OM1=0,OL1=0,OM0=0,OL0=0 */
  clrReg8Bits(TCTL2, 0x3FU);            
  /* TTOV: TOV2=0,TOV1=0,TOV0=0 */
  clrReg8Bits(TTOV, 0x07U);             
  /* TSCR2: TCRE=0,PR2=0,PR1=1,PR0=1 */
  clrSetReg8Bits(TSCR2, 0x0CU, 0x03U);  
  /* TFLG1: C7F=1,C6F=1,C5F=1,C4F=1,C3F=1,C2F=1,C1F=1,C0F=1 */
  setReg8(TFLG1, 0xFFU);                
  /* TIE: C2I=1,C1I=1,C0I=1 */
  setReg8Bits(TIE, 0x07U);              
  ...
  /* ### MC9S12C32_80 "Cpu" init code ... */
  /* ### BitsIO "CAMPO" init code ... */
  /* ### TimerInt "LEDON" init code ... */
  /* TC1: BIT15=1,BIT14=1,BIT13=1,BIT12=1,BIT11=0,BIT10=1,BIT9=0,BIT8=0,BIT7=0,BIT6=0,BIT5=1,BIT4=0,BIT3=0,BIT2=1,BIT1=0,BIT0=0 */
  setReg16(TC1, 0xF424U);              /* Store given value to the compare register */ 
  /* ### TimerInt "main_project" init code ... */
  ...
  /* ### TimerInt "LEDOFF" init code ... */
  /* TC2: BIT15=1,BIT14=1,BIT13=1,BIT12=1,BIT11=0,BIT10=1,BIT9=0,BIT8=0,BIT7=0,BIT6=0,BIT5=1,BIT4=0,BIT3=0,BIT2=1,BIT1=0,BIT0=0 */
  setReg16(TC2, 0xF424U);              /* Store given value to the compare register */ 
